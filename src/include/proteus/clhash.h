 ...
 * using carry-less multiplications, Journal of Cryptographic Engineering (to
 *appear)
 *
 * Best used on recent x64 processors (Haswell or better).
 *
 * Compile option: if you define BITMIX during compilation, extra work is done
 *to pass smhasher's avalanche test succesfully. Disabled by default.
 **/
 ...
 *  also be aligned on 16-byte boundaries so that (((uintptr_t) random & 15) ==
 * 0) for performance reasons. This is usually generated once and reused with
 * many inputs.
 *
 *
